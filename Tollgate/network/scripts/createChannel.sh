...
createChannelTx mychannel Channel

## Create anchorpeertx
infoln "Generating anchor peer update transactions"
createAnchorPeerTx Tg1MSP mychannel Channel

## Create channel
infoln "Creating channel mychannel"
createChannel ${_tg1_0[@]}

## Join all the peers to the channel
infoln "Join peers to the mychannel..."
joinChannel ${_tg1_0[@]}

## Set the anchor peers for each org in the channel
infoln "Updating anchor peers for tg1..."
updateAnchorPeers ${_tg1_0[@]}
