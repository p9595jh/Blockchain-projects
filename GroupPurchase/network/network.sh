...
function createOrgs() {
  ...
  infoln "Create Seller1 Identites"
  ...
  infoln "Create Seller2 Identites"
  ...
  orgEnv customer 9054
  createOrg $SERV_NM $ORG_ADDR $CAPORT
  registerPeer ${regiParams[@]} peer0
  registerPeer ${regiParams[@]} peer1
  registerPeer ${regiParams[@]} peer2
  registerUser ${regiParams[@]} user1 User1
  registerAdmin ${regiParams[@]} ${ORG_ADDR}admin Admin

  infoln "Create Item Identites"
  ...
  ./organizations/ccp-generate.sh ${SERV_NM} seller1 Seller1 7051 7054 peer0
  ./organizations/ccp-generate.sh ${SERV_NM} seller2 Seller2 8051 8054 peer0
  ./organizations/ccp-generate.sh ${SERV_NM} customer Customer 9051 9054 peer0
  ./organizations/ccp-generate.sh ${SERV_NM} customer Customer 10051 9054 peer1
  ./organizations/ccp-generate.sh ${SERV_NM} customer Customer 11051 9054 peer2
  ./organizations/ccp-generate.sh ${SERV_NM} item Item 12051 10054 peer0
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/seller1/msp organizations/fabric-ca/seller1/tls-cert.pem organizations/fabric-ca/seller1/ca-cert.pem organizations/fabric-ca/seller1/IssuerPublicKey organizations/fabric-ca/seller1/IssuerRevocationPublicKey organizations/fabric-ca/seller1/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/seller2/msp organizations/fabric-ca/seller2/tls-cert.pem organizations/fabric-ca/seller2/ca-cert.pem organizations/fabric-ca/seller2/IssuerPublicKey organizations/fabric-ca/seller2/IssuerRevocationPublicKey organizations/fabric-ca/seller2/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db'
    ...
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/item/msp organizations/fabric-ca/item/tls-cert.pem organizations/fabric-ca/item/ca-cert.pem organizations/fabric-ca/item/IssuerPublicKey organizations/fabric-ca/item/IssuerRevocationPublicKey organizations/fabric-ca/item/fabric-ca-server.db'
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/ordererOrg/msp organizations/fabric-ca/ordererOrg/tls-cert.pem organizations/fabric-ca/ordererOrg/ca-cert.pem organizations/fabric-ca/ordererOrg/IssuerPublicKey organizations/fabric-ca/ordererOrg/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg/fabric-ca-server.db'
