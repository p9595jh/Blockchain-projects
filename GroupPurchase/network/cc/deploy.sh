...
if [ "$CHANNEL_NAME" = "sellchannel1" ]; then

  param1=("${_seller1_p0_ch0[@]}")
  param2=("${_customer_p0_ch0[@]}")
  param3=("${_customer_p1_ch0[@]}")


elif [ "$CHANNEL_NAME" = "itemchannel" ]; then

  param1=("${_seller1_p0_ch1[@]}")
  param2=("${_seller2_p0_ch1[@]}")
  param3=("${_item_p0_ch0[@]}")


elif [ "$CHANNEL_NAME" = "sellchannel2" ]; then

  param1=("${_seller2_p0_ch0[@]}")
  param2=("${_customer_p1_ch1[@]}")
  param3=("${_customer_p2_ch0[@]}")
