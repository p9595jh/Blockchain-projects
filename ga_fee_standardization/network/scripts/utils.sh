...
CHANNEL_PROFILE='HnChannelProfile'

# {organization name}{channel number}
# if organization is 'INS1' and channel number is 1 (means 'hnchannel1'), the name of the variable might be 'ins11'
# not applied to 'ga's
ins11=(ins1 Ins1 peer0 Admin 7051 ${CHANNEL_NAME}1)
ins21=(ins2 Ins2 peer0 Admin 8051 ${CHANNEL_NAME}1)
ins22=(ins2 Ins2 peer0 Admin 8051 ${CHANNEL_NAME}2)
ins32=(ins3 Ins3 peer0 Admin 9051 ${CHANNEL_NAME}2)
ga1=(ga1 Ga1 peer0 Admin 10051 ${CHANNEL_NAME}1)
ga2=(ga2 Ga2 peer0 Admin 11051 ${CHANNEL_NAME}2)
