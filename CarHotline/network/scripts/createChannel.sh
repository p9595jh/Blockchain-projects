...
createChannelTx mainchannel MainChannel
createChannelTx channel2 Channel2

## Create anchorpeertx
infoln "Generating anchor peer update transactions"
createAnchorPeerTx Car1MSP channel1 Channel1 Channel1
createAnchorPeerTx Car1MSP mainchannel MainChannel MainChannel
createAnchorPeerTx Car2MSP channel2 Channel2 Channel2
createAnchorPeerTx Car2MSP mainchannel MainChannel MainChannel
createAnchorPeerTx Car3MSP channel1 Channel1 Channel1
createAnchorPeerTx Car3MSP mainchannel MainChannel MainChannel
createAnchorPeerTx Car4MSP channel1 Channel1 Channel1
createAnchorPeerTx Car4MSP channel2 Channel2 Channel2
createAnchorPeerTx Car4MSP mainchannel MainChannel MainChannel
createAnchorPeerTx Car5MSP channel2 Channel2 Channel2
createAnchorPeerTx Car5MSP mainchannel MainChannel MainChannel
createAnchorPeerTx MainMSP mainchannel MainChannel

## Create channel
infoln "Creating channel channel1"
createChannel ${_car1_p0_ch0[@]}

infoln "Creating channel mainchannel"
createChannel ${_car1_p0_ch1[@]}

infoln "Creating channel channel2"
createChannel ${_car2_p0_ch0[@]}

## Join all the peers to the channel
infoln "Join peers to the channel1..."
joinChannel ${_car1_p0_ch0[@]}
joinChannel ${_car3_p0_ch0[@]}
joinChannel ${_car4_p0_ch0[@]}

infoln "Join peers to the mainchannel..."
joinChannel ${_car1_p0_ch1[@]}
joinChannel ${_car2_p0_ch1[@]}
joinChannel ${_car3_p0_ch1[@]}
joinChannel ${_car4_p0_ch2[@]}
joinChannel ${_car5_p0_ch1[@]}
joinChannel ${_main_p0_ch0[@]}

infoln "Join peers to the channel2..."
joinChannel ${_car2_p0_ch0[@]}
joinChannel ${_car4_p0_ch1[@]}
joinChannel ${_car5_p0_ch0[@]}

## Set the anchor peers for each org in the channel
infoln "Updating anchor peers for channel1..."
updateAnchorPeers ${_car1_p0_ch0[@]} Channel1

infoln "Updating anchor peers for mainchannel..."
updateAnchorPeers ${_car1_p0_ch1[@]} MainChannel

infoln "Updating anchor peers for channel2..."
updateAnchorPeers ${_car2_p0_ch0[@]} Channel2
