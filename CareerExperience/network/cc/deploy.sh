...
if [ "$CHANNEL_NAME" = "channel1" ]; then
  ...
  param1=("${_company1_p0_ch0[@]}")
  param2=("${_employee_p0_ch0[@]}")
  param3=("${_employee_p1_ch0[@]}")
...
approveForMyOrg ${param3[@]}
  ...
  commitChaincodeDefinition ${param1[@]} ${param2[@]} ${param3[@]}
...
queryCommitted ${param3[@]}
  ...
  if [ "$CC_INIT_FCN" = "NA" ]; then
    ...
    chaincodeInvokeInit ${param1[@]} ${param2[@]} ${param3[@]}
  fi

elif [ "$CHANNEL_NAME" = "careerchannel" ]; then

  param1=("${_company1_p0_ch1[@]}")
  param2=("${_company2_p0_ch1[@]}")
  param3=("${_employee_p0_ch1[@]}")
  param4=("${_employee_p1_ch1[@]}")
  param5=("${_employee_p2_ch1[@]}")
  param6=("${_employee_p3_ch1[@]}")
  param7=("${_career_p0_ch0[@]}")
...
queryCommitted ${param7[@]}
  ...
  param1=("${_company2_p0_ch0[@]}")
  param2=("${_employee_p2_ch0[@]}")
  param3=("${_employee_p3_ch0[@]}")
